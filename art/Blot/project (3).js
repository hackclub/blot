...
@author: Jakob
@snapshot: house_snapshot_3
*/

const width = 125;
const height = 125;

const houseWidth = 91;  // Width of the house
const roofHeight = 32;  // Height of the roof
...
drawLines([
    ...
    // Chimney
    [[(width / 2) + 10, roofHeight + roofHeight - 7], [(width / 2) + 10, roofHeight + roofHeight]],
    [[(width / 2) + 10, roofHeight + roofHeight], [(width / 2) + 15, roofHeight + roofHeight]],
    [[(width / 2) + 15, roofHeight + roofHeight], [(width / 2) + 15, roofHeight + roofHeight - 11]],
]);
