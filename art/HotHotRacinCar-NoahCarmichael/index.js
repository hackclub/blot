...
const xc = bt.randIntInRange(-11, 40); 
const yc = bt.randIntInRange(0, 15); 
const mod = bt.randInRange(1, 1.3); 
...
// cloud
const curve = bt.catmullRom([[xc+20, 93+yc], [xc*mod+26, 107+yc], [xc*mod+37, 103+yc], [xc*mod+48, 109+yc], [xc+55, 93+yc], [xc+20, 93+yc]])
drawLines([curve])
