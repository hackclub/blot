...
const randx2 = bt.randIntInRange(0,50)
//I thought the changing y-values looked nauseous when you run it continuously
const randy2 = bt.randIntInRange(32, 50)
...
bt.join(circleLines, circleleft, circleright, circleleft1, circleright1, circleleft2, circleright2)
const randinsky2 = bt.randIntInRange(12,45)
const randinskx2 = bt.randIntInRange(50,73)
bt.translate(circleLines, [randinskx2,randinsky2], [0,0])
bt.copy(circleLines)
