...
const blue = `#0000${((bt.randInRange(0.1, 1) * 255) | 0).toString(16).padStart(2, '0')}`
...
drawLines([sun([sunX,sunY],sunRadius)], {fill: yellow})
  ...
  drawLines([ground])
  drawLines([sun([sunX,sunY],sunRadius)])
}
