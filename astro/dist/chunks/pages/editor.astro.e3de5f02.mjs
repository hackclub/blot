import { _ as __astro_tag_component__, s as spreadAttributes, c as createAstro, a as createComponent, r as renderTemplate, b as addAttribute, d as renderHead, e as renderSlot, f as renderComponent, m as maybeRenderHead } from "../astro.2c740cbe.mjs";
import "html-escaper";
import { useMemo, useCallback, useEffect, useState, useRef } from "preact/hooks";
import { s as styles, a as styles$1, b as styles$2, c as styles$3, d as styles$4, e as styles$5, f as styles$6, g as styles$7, h as styles$8, i as styles$9, j as styles$a } from "../editor.cf886239.844ede4b.mjs";
import cx from "classnames";
import { jsx, jsxs, Fragment } from "preact/jsx-runtime";
import { nanoid } from "nanoid";
import { useReducer, useEffect as useEffect$1 } from "react";
...
function Dialog({
  ...
  return show ? jsx("div", {
    class: cx(styles$1.root, className),
    onKeyDown: (e) => {
      if (e.key === "Escape") {
        close();
      }
...
const createState = (initialValue) => {
  ...
  const [useReceiver, emitter] = createEvent$1();
  return [(keys) => {
    if (keys !== null) {
...
function Preview(props) {
  ...
  return jsxs("div", {
    class: styles$2.root,
    children: [jsx("canvas", {
      class: `${styles$2.canvas} ${props.className} main-canvas`
    }), jsx("div", {
      class: `${styles$2.mousePosition} mouse-position`
    }), jsx(Button, {
      class: `${styles$2.centerButton} center-view-trigger`,
      variant: "ghost",
      icon: true,
...
function NewButton() {
  return jsx(Button, {
    variant: "ghost",
    onClick: () => {
      loadCodeFromString(defaultProgram$1);
    },
    children: "new"
  });
}
...
const BezierEditor = ({
  ...
  return jsxs("div", {
    ...
    children: [jsxs("svg", {
      ref,
      class: ["bez-ctrl", styles$4.bezCtrl].join(" "),
      width: "250",
      height: "250",
      ...
      children: ["start: ", yStartView.toFixed(2), ","]
    }), jsxs("div", {
      children: ["handle0: [", p0xView.toFixed(1), ",", p0yView.toFixed(1), "],"]
    }), jsxs("div", {
      children: ["handle1: [", p1xView.toFixed(1), ",", p1yView.toFixed(1), "],"]
    }), jsxs("div", {
      children: ["end: ", yEndView.toFixed(2)]
    })]
  });
};
function drawGrid({
...
__astro_tag_component__(BezierEditor, "@astrojs/preact");
...
const [useOnCloseBezierWidget, dispatchCloseBezierWidget] = createEvent$1();
...
const bezierWidget = makeWidget(({
  ...
  const createLiveUpdateSpans = () => Object.values(props).flat().map((node) => createSpan(node.from, node.to, view));
  ...
  return jsxs("span", {
    class: styles$5.bezierWidget,
    children: [popupSide !== null && jsx("div", {
      class: styles$5.bezierWidgetPopup,
      style: {
      ...
      class: styles$5.bezierWidgetBtn,
      onClick: (e) => {
        if (popupSide !== null) {
          setPopupSide(null);
          return;
...
const createCMState = (doc = "") => EditorState.create({ extensions: cmExtensions, doc });
const [useOnJumpTo, dispatchJumpTo] = createEvent$1();
  ...
  return jsxs("pre", {
    ...
    children: [jsxs("div", {
      ...
      children: [hasContext && jsxs(Fragment, {
        ...
        class: styles$6.arrow,
        children: "↑"
      }), message && jsx("span", {
        class: styles$6.message,
        children: message
      })]
    }), jsxs("button", {
      class: styles$6.jumpTo,
  ...
  return jsxs("div", {
    ...
    children: [jsx("span", {
      ...
      children: [jsx("summary", {
        class: styles$6.stackLabel,
        children: "stack trace"
      }), jsx("div", {
        class: styles$6.stack,
...
function Console() {
  ...
  return jsxs("div", {
    class: styles$7.root,
    children: [jsxs("div", {
      class: styles$7.header,
      children: [jsx("span", {
        children: "console"
      }), jsx(Button, {
        class: styles$7.clearButton,
        variant: "ghost",
        icon: true,
        "aria-label": "clear",
        onClick: () => patchStore({
      ...
      children: console2.map(({
        ...
        class: cx(styles$7.line, type === "warn" ? styles$7.tWarn : type === "error" && styles$7.tError),
        children: [jsx("div", {
          class: styles$7.time,
          children: new Date(time).toLocaleTimeString()
        }), jsx("div", {
          class: styles$7.values,
...
function CodeMirror() {
  ...
  return jsxs(Fragment, {
    children: [jsx("style", {
      ...
      class: [styles$8.cmWrapper, "cm-editor"].join(" "),
      ref: editorRef
    })]
  });
}
__astro_tag_component__(CodeMirror, "@astrojs/preact");
function addBezierControl() {
  ...
  listen("mousemove", ".bez-ctrl, .bez-ctrl *", (e) => {
    if (draggedElement === null || svg === null)
      return;
...
const html$1 = updateImageReferences('<h3 id="turtle">Turtle</h3>\n<p>Our main drawing primative is a turtle. It’s a collection of polylines with an associated pen that has a location and direction.</p>\n<pre class="language-plaintext"><code is:raw="" class="language-plaintext">const t = createTurtle();\n\n// move turtle up and down\nt.up()\nt.down()\n\n// draw paths\nt.goto(x: number, y: number)\nt.forward(distance: number)\nt.arc(angle: number, radius: number)\n\n// change angle\nt.setAngle(theta: number)\nt.right(theta: number)\nt.left(theta: number)\n\n// transform turtle path\n// type pt = [ number, number ]\nt.translate(from: pt, to: pt)\nt.rotate(angle: number, origin: pt)\nt.scale(factor: number, origin: pt)\n\n// import svgs\nt.fromSVG(svgString: string)\n\n// Turtle special points and dimensions\n/*\nYou can get 9 points of interest from the turtle as get methods.\nl is left, r is right, c is center, b is bottom.\nThe points are as such.\n\nlt -- ct -- rt\n|     |     |\nlc -- cc -- rc\n|     |     |\nlb -- cb -- rb\n\nYou can also get the start, end, width, and height\n*/\n\nt.lt\nt.ct\nt.rt\nt.lc\nt.cc\nt.rc\nt.lb\nt.cb\nt.rb\nt.start\nt.end\n\nt.width\nt.height\n\n// to add turtles together\nt.join(anotherTurtle)\n\n// to apply a function to all pts in a turtle\n// this will replace the old point values with the new ones\nt.iteratePath(fn)\n\nt.resample(resolution)\n\nt.interpolate(tValue)</code></pre>\n<p>To render a turtle use <code>drawTurtles</code> it is variadic (can take multiple turtles as arguments).</p>\n<pre class="language-js"><code is:raw="" class="language-js"><span class="token function">drawTurtles</span><span class="token punctuation">(</span><span class="token operator">...</span>turtles<span class="token punctuation">)</span></code></pre>\n<p>You can drag in SVG’s, and the interface will generate a turtle for it. Keep in mind that SVG’s are often imported far too large, and will need to be scaled and translated.</p>\n<h3 id="randomness">Randomness</h3>\n<pre class="language-js"><code is:raw="" class="language-js"><span class="token function">rand</span><span class="token punctuation">(</span><span class="token punctuation">)</span>\n<span class="token function">setRandSeed</span><span class="token punctuation">(</span>seed<span class="token operator">:</span> number<span class="token punctuation">)</span>\n<span class="token function">randInRange</span><span class="token punctuation">(</span>min<span class="token operator">:</span> number<span class="token punctuation">,</span> <span class="token literal-property property">max</span><span class="token operator">:</span> number<span class="token punctuation">)</span>\n<span class="token function">randIntInRange</span><span class="token punctuation">(</span>min<span class="token operator">:</span> number<span class="token punctuation">,</span> <span class="token literal-property property">max</span><span class="token operator">:</span> number<span class="token punctuation">)</span></code></pre>\n<h3 id="noise">Noise</h3>\n<p>Noise is one of the most powerful tools for making proceduarally generated natural looking things. It can be thought of as smooth randomness.</p>\n<pre class="language-js"><code is:raw="" class="language-js"><span class="token comment">// y and z are optional</span>\n<span class="token function">noise</span><span class="token punctuation">(</span>\n  <span class="token punctuation">[</span>\n    <span class="token literal-property property">x</span><span class="token operator">:</span> number<span class="token punctuation">,</span>\n    <span class="token literal-property property">y</span><span class="token operator">:</span> number<span class="token punctuation">,</span>\n    <span class="token literal-property property">z</span><span class="token operator">:</span> number\n  <span class="token punctuation">]</span><span class="token punctuation">,</span>\n  <span class="token punctuation">{</span>\n    octaves <span class="token operator">=</span> <span class="token number">4</span><span class="token punctuation">,</span>\n    falloff <span class="token operator">=</span> <span class="token number">0.5</span>\n  <span class="token punctuation">}</span>\n<span class="token punctuation">)</span></code></pre>\n<p>Can be used like such</p>\n<pre class="language-js"><code is:raw="" class="language-js"><span class="token function">noise</span><span class="token punctuation">(</span><span class="token punctuation">[</span><span class="token number">2</span><span class="token punctuation">,</span> <span class="token number">3</span><span class="token punctuation">]</span><span class="token punctuation">)</span></code></pre>\n<h3 id="utilities">Utilities</h3>\n<pre class="language-js"><code is:raw="" class="language-js"><span class="token comment">// min: number, max: number, t: number (0 to 1)</span>\n<span class="token function">lerp</span><span class="token punctuation">(</span>min<span class="token punctuation">,</span> max<span class="token punctuation">,</span> t<span class="token punctuation">)</span></code></pre>\n<h2 id="examples">Examples</h2>\n<p>To find examples check out <a href="/gallery"><code>/gallery</code></a>.</p>');
...
function Help({
  ...
  const [tab, setTab] = useState(workshop ? "workshop" : "toolkit");
  return jsx(Fragment, {
    children: jsxs("div", {
      class: styles$9.helpSection,
      style: {
        height: `${helpHeight}%`
      },
      children: [jsxs("div", {
        class: styles$9.helpSectionToolbar,
        children: [workshop && jsx("a", {
          className: styles$9.helpSectionTab,
          style: {
            backgroundColor: tab == "workshop" ? "rgba(var(--primary-rgb), 0.9)" : ""
          },
          onClick: () => {
            setTab("workshop");
            if (closed)
          ...
          className: styles$9.helpSectionTab,
          style: {
            backgroundColor: tab == "toolkit" ? "rgba(var(--primary-rgb), 0.9)" : ""
          },
          onClick: () => {
            setTab("toolkit");
            if (closed)
          ...
          className: styles$9.helpSectionTab,
          onClick: toggleClose,
          children: closed ? "Open Help" : "Close Help"
        })]
      }), tab === "toolkit" && jsx("div", {
        dangerouslySetInnerHTML: {
          __html: html
        },
        class: styles$9.helpContent
      }), tab === "workshop" && jsxs("div", {
        class: styles$9.helpContent,
        children: [jsx("h1", {
          children: workshop.frontmatter.title
        }), jsx("div", {
          dangerouslySetInnerHTML: {
            __html: workshop.content
          }
        }), jsx("p", {
          children: jsx("a", {
            href: `/guide/${workshop.slug}`,
            children: "Open as full page"
          })
        })]
      })]
    })
...
__astro_tag_component__(Help, "@astrojs/preact");
function Editor({
  tutorial
}) {
  ...
  useEffect(() => {
    init();
    addEditorResizing(setWidth, theme2);
    addHelpResizing(setHelpHeight, editorContainer, theme2);
  }, []);
  const closeHelpPane = () => {
    const closed = helpHeight <= 0;
    let count = 0;
  ...
  return jsxs(Fragment, {
    children: [jsx(GlobalStateDebugger, {}), jsxs("div", {
      class: styles$a.root,
      children: [jsx(Toolbar, {}), jsxs("div", {
        class: styles$a.inner,
        ref: editorContainer,
        children: [jsxs("div", {
          style: {
            "width": `${width}%`,
          ...
          children: [jsx("div", {
            ...
            children: [jsx(Console, {}), jsx(Error$1, {})]
          })]
        }), jsx("div", {
          class: `${styles$a.vertBar} resize-code-trigger`,
          style: {
            left: `${width}%`
          }
        }), jsxs("div", {
          class: styles$a.right,
          style: {
            width: `${100 - width}%`
          },
          children: [jsx(Preview, {}), jsx("div", {
            class: `${styles$a.horizBar} resize-help-trigger`,
            style: {
              top: `${100 - helpHeight}%`,
              width: `${100 - width}%`
            }
...
function addEditorResizing(setWidth, theme2) {
  const listen = createListener(document.body);
  let clicked = false;
  let bar = null;
  listen("mousedown", ".resize-code-trigger", (e) => {
    ...
    if (bar === null)
      return;
    bar.style.width = "8px";
    bar.style.background = theme2 === 1 ? "#404040" : "#eee";
  });
  listen("mousemove", "", (e) => {
    if (clicked) {
      e.preventDefault();
...
function addHelpResizing(setHeight, container, theme2) {
  const listen = createListener(document.body);
  let clicked = false;
  let bar = null;
...
const $$EditorLayout = createComponent(async ($$result, $$props, $$slots) => {
  const Astro2 = $$result.createAstro($$Astro$1, $$props, $$slots);
  Astro2.self = $$EditorLayout;
  ...
  <head>
    ...
    <title>Blot | ${title}</title>
  ${renderHead()}</head>
  <body>
    ${renderSlot($$result, $$slots["default"])}
  </body></html>`;
}, "/Users/jchen/Documents/Programming/haxidraw/new/astro/src/layouts/EditorLayout.astro", void 0);
const $$Astro = createAstro("https://haxidraw.hackclub.com");
const prerender = false;
const $$Editor = createComponent(async ($$result, $$props, $$slots) => {
  const Astro2 = $$result.createAstro($$Astro, $$props, $$slots);
  Astro2.self = $$Editor;
  const files = await Astro2.glob(/* @__PURE__ */ Object.assign({ "../guides/10PRINT.md": () => import("../10PRINT.0b5b2cbd.mjs"), "../guides/10PRINT2.md": () => import("../10PRINT2.1799135f.mjs"), "../guides/cubic_disarray.md": () => import("../cubic_disarray.b847e88c.mjs"), "../guides/eca.md": () => import("../eca.f6a41b6d.mjs"), "../guides/joydivision.md": () => import("../joydivision.fd20329a.mjs"), "../guides/landscape.md": () => import("../landscape.e6d6240e.mjs"), "../guides/leaf.md": () => import("../leaf.58085b6c.mjs"), "../guides/mesh.md": () => import("../mesh.90ad879c.mjs"), "../guides/raymarching.md": () => import("../raymarching.ce3ae146.mjs"), "../guides/roots.md": () => import("../roots.31c944ec.mjs"), "../guides/square-disarray.md": () => import("../square-disarray.480d94a9.mjs") }), () => "/../guides/*.md");
  const query = Astro2.url.searchParams.get("tutorial");
  let tutorial = void 0;
  if (query)
    files.map((file) => {
      if (file.file.endsWith(query + ".md"))
        tutorial = file;
    });
  if (tutorial)
    tutorial = { ...tutorial, content: tutorial.compiledContent(), slug: query };
  return renderTemplate`${renderComponent($$result, "EditorLayout", $$EditorLayout, { "title": "Editor", "description": "Editor" }, { "default": ($$result2) => renderTemplate`
  ${maybeRenderHead()}<main>
    ${renderComponent($$result2, "Editor", Editor, { "client:load": true, "tutorial": tutorial, "client:component-hydration": "load", "client:component-path": "/Users/jchen/Documents/Programming/haxidraw/new/astro/src/Editor.tsx", "client:component-export": "default" })}
  </main>
` })}`;
}, "/Users/jchen/Documents/Programming/haxidraw/new/astro/src/pages/editor.astro", void 0);
const $$file = "/Users/jchen/Documents/Programming/haxidraw/new/astro/src/pages/editor.astro";
const $$url = "/editor";
export {
  $$Editor as default,
  $$file as file,
