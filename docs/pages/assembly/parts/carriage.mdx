...
- Attach the v-wheels to the carriage.
  ...
  - _💡 Pro tip: inside the v-wheel's casing there are two bearings with a shim between them. Occasionally the shim will come misaligned - if this occurs, don't fret! Simply take a small allen key, insert it into both the bearing and shim's holes, and move it in a circle to recenter the shim._
