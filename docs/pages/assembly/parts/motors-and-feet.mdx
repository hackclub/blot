...
- Slide the carriage onto the aluminum extrusion, making sure it is in the orientation indicated in the picture (bottom of the carriage with the v-wheels for the Y axis extrusion on the side opposite to the single side which does _not_ have a motor bracket screw).
