    ...
    _parseNumber: function () {
        ...
        if (
            ...
            while (
                ...
                frac *= 10;
                decimal +=
                    (this._string.charAt(this._currentIndex) - "0") / frac;
                this._currentIndex += 1;
            }
        }
...
const path = function (options) {
    if (options && options.normalize) {
        if (this[$cachedNormalizedPathData]) {
            ...
            var normalizedPathData = reducePathData(
                absolutizePathData(pathData)
            );
...
export function getPathData(svgElement, options) {
